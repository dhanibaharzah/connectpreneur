...
/** Default Neon row shape (arrayMode: false, fullResults: false). */
export type SqlRow = Record<string, any>
export type SqlResult = SqlRow[]
...
export function sql(strings: TemplateStringsArray, ...values: unknown[]): Promise<SqlResult> {
  return getSqlClient()(strings, ...values) as Promise<SqlResult>
}
