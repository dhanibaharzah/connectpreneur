...
export function BelanjaFooter({ homePath, onSubdomain }: BelanjaFooterProps) {
      ...
      <div className="container mx-auto max-w-6xl space-y-10">
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between lg:gap-8">
          <div className="flex max-w-sm flex-col gap-5">
            ...
            <p className="text-sm font-medium text-white/95">
              Marketplace produk dan jasa dari mitra ConnectPreneur. Dukung usaha lokal dan temukan
              penawaran terbaik dari mitra terpercaya di seluruh Indonesia.
            </p>
          </div>

          <div className="flex flex-col gap-4 text-sm font-medium">
            <Link href={homePath} className="transition hover:text-[#f9c8b6]">
              Beranda Belanja
            </Link>
            <Link href={akunPath} className="transition hover:text-[#f9c8b6]">
              Akun Saya
            </Link>
          ...
          <div className="flex max-w-xs flex-col gap-5">
            <div className="space-y-3 text-sm">
              ...
              <p className="font-normal leading-normal text-white/95">
                Ingin menjual produk di Belanja ConnectPreneur? Hubungi tim kami untuk info pendaftaran
                mitra.
              </p>
            </div>
            <div className="inline-flex max-w-full items-center gap-3 rounded-full bg-[#fdede8] py-1 pl-3 pr-1">
              ...
              <Link
                href="https://wa.me/6285221223145?text=Halo%20Kak%20Karso,%20saya%20ingin%20menjual%20produk%20di%20Belanja%20ConnectPreneur"
                target="_blank"
        ...
        <div className="space-y-3 rounded-xl bg-[rgba(253,237,232,0.2)] px-4 py-3">
          ...
          <p className="text-xs font-normal leading-snug text-white/95">
            ConnectPreneur Belanja hanya berfungsi sebagai platform penghubung antara pembeli dan mitra
            ConnectPreneur. Harga yang ditampilkan bersifat indikatif dan dapat berubah sewaktu-waktu. Segala
            transaksi pembelian dilakukan langsung antara pembeli dan mitra ConnectPreneur. ConnectPreneur
            tidak bertanggung jawab atas kualitas produk, keterlambatan pengiriman, atau kerugian yang mungkin
            timbul dari transaksi. Selalu verifikasi mitra dan produk sebelum bertransaksi.
          </p>
        </div>
