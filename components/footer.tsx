...
export function Footer() {
  return (
    <footer id="tentang" className="bg-foreground text-background py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-background/80 text-sm">
              Platform katalog bisnis yang menghubungkan Anda dengan berbagai peluang usaha dan program kemitraan
          ...
          <div>
            ...
            <p className="text-sm text-background/80 mb-4">
              Ingin mendaftarkan bisnis Anda?
              <br />
        ...
        <div className="border-t border-background/20 mt-8 pt-6">
          <div className="bg-background/10 rounded-lg p-4 mb-6">
            <p className="text-xs text-background/70 text-center leading-relaxed">
              ...
              BOEMKraf tidak bertanggung jawab atas wanprestasi atau kerugian yang mungkin timbul dari kerjasama bisnis. 
